...
Player::Player(char piece, const std::string &name, int wallet, Bank &bank, int position, bool visitingTims,
               int timsLine, int timsCups, int boardSize, int gyms, int res, bool buy, bool pay, int fee, std::string feeOwner) : piece(piece), name(name), wallet(wallet), boardSize(boardSize), position(position), visitingTims(visitingTims),
                                                                                                                                  timsLine(timsLine), timsCups(timsCups), gyms(gyms), res(res), bank(bank),
